...
import { createPost, getPostByID, updatePost, deletePost, } from "../services/posts.js";
...
describe("creating posts", () => {
    ...
    test("without title should fail", async () => {
        ...
        try {
            ...
            expect(validationError.errors.title?.message).toContain("Title is required");
        }
    });
    test("without contents should fail", async () => {
        ...
        try {
            ...
            expect(validationError.errors.contents.message).toContain("Blog content is required");
        }
    });
...
const samplePosts = [
    ...
    },
    {
        ...
        author: "Dipesh Gavit",
        contents: "This is th efull and simple guied for MERN stack CRUD web app",
...
describe("updating posts", () => {
    ...
    test("Should update updatedAt timestamp", async () => {
        ...
        const updatedPost = await Post.findById(firstPost._id);
        expect(updatedPost).toBeDefined();
        expect(updatedPost.updatedAt.getTime()).toBeGreaterThan(firstPost.updatedAt.getTime());
    });
